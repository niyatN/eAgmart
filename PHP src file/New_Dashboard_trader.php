        ...
        <div align="center">
          ...
          ?>
            ...
            <table class="data-table">
              ...
              <tbody>
              <?php
              $sql="SELECT * FROM produce_detail";
                ...
                while ($row=mysqli_fetch_assoc($res)) {
                  echo"<tr>";
                    ...
                    <input type="hidden" value="<?php echo $row['Id'] ?>" name="req_id" />
                    <input type="hidden" value="<?php echo $row['Farmer_Name'] ?>" name="far_name" />
                    <input type="hidden" value="<?php echo $row['farmer_id'] ?>" name="far_id" />
                    <input type="hidden" value="<?php echo $row['Product'] ?>" name="product" />
                    <input type='submit' class='btn btn-success' id='deal' onclick="alert('Deal Done Successfully')" name='deal' value='Deal Done' />
                    </form>
                    <?php
                    echo "</td>";
                  echo"</tr>";
