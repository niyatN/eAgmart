        ...
        <a href="file:///F:/SEM-3/SOFTWARE%20PROJECT/AdminLTE-master/index2.html" class="logo"><img src="./New_ Dashboard_files/Resized-9KMC8.jpg"><b style="padding-left: 5px;">eAgmart</b>
          ...
          <div  class="navbar-custom-menu">
                    <div class="pull-right" style="background-color:green; margin-left:300px; margin-top: 7px;">
                      <a href="sign_out.php" class="btn btn-success">Sign out</a>
                    </div>
          </div>
        </nav>
      </header>
      <aside class="main-sidebar">
        <section class="sidebar" style="height: auto;">
          <ul class="sidebar-menu">
            ...
            <li class="active treeview">
                <li><a href="New_Dashboard_farmer.php"><i class="fa fa-circle-o"></i>Farmer</a></li>
            </li>
            <li class="treeview">
        ...
        <div align="center">
          ...
          ?>
            ...
            <table class="data-table">
              ...
              <?php
              $un=$_SESSION['farmer'];
              $sql="SELECT * FROM produce_detail where farmer_id='$un' ";
